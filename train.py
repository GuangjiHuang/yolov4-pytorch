...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    train_annotation_path   = 'head_train.txt'
    val_annotation_path     = 'head_val.txt'
    ...
    if True:
        ...
        val_dataset     = YoloDataset(val_lines, input_shape, num_classes, epoch_length = UnFreeze_Epoch, mosaic=False, train = False) # train is False, not increase the data
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            # set the optimeizer's learning rate
