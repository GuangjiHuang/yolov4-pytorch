...
def fit_one_epoch(model_train, model, yolo_loss, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, cuda, fp16, scaler, save_period, save_dir, local_rank=0):
    ...
    for iteration, batch in enumerate(gen):
        ...
        # images is the tensor, [batch_size, c, h, w], targets is the list or the tuple with the tensor as element
        ...
        if not fp16:
            ...
            #   计算损失
            #----------------------#
            # three level or the feature map output, 13x13, 26x26, and the 52x53
